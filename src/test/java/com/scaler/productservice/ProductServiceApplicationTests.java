...
//        String productId = "7";
//        fakeStoreRequestDTO.setId(productId);
//        fakeStoreRequestDTO.setTitle("hello test product");
//
//        HttpHeaders headers = new HttpHeaders();
//        headers.setContentType(MediaType.APPLICATION_JSON);
//        HttpEntity<FakeStoreRequestDTO> entity = new HttpEntity<>(fakeStoreRequestDTO, headers);
//
